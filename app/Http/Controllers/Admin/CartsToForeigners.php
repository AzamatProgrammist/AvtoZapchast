...
class CartsToForeigners extends Controller
{
    ...
    {
        $carts_to_foreigner = Carts_to_foreigners::findOrFail($id);
        $carts_to_foreigner->delete();
        return redirect()->route('admin.carts_to_foreigners.index')->with('success', "Buyurtma bekor qilindi");
    }
}

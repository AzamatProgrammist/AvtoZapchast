      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- <li class="dropdown">
              <a href="{{ route('admin.barcodes.index')}}" class="nav-link"><i data-feather="dollar-sign"></i><span>@lang('words.barcode')</span></a>
            </li> -->
            <li class="dropdown">
              <a href="{{ route('admin.astatka.index')}}" class="nav-link"><i data-feather="dollar-sign"></i><span>@lang('words.остатки')</span></a>
            </li>
            @endhasanyrole
            <li class="dropdown">
